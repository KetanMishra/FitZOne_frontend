...
export class OpenAIService {
  ...
  async generateHealthResponse(userMessage: string): Promise<string> {
    ...
    const systemPrompt = `You are a specialized AI health and fitness assistant for FitZone gym. You ONLY respond to health, fitness, nutrition, and wellness-related questions. 
